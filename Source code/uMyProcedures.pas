...
Uses
  ProgramRun, Graphics, SysUtils, uShowMaze, Dialogs,
...
Begin
  ...
  Begin
    ShowMessage('Ўирина и высота должна быть больше 2 €чеек');
    Result := False;
  End;
End;
...
begin
  ...
  Begin
    ShowMessage('Ћабиринт не найден');
    Result := True;
  End;
end;
...
Begin
  ...
  Begin
    ...
    ShowMessage('¬ведите (высоту > 2) и (ширину > 2) лабиринта перед генерацией');
  End
  Else
  Begin
    // Prim's algorithm
